...
class Bottleneck4DenseNet(BottleneckBase):
    ...
    def __init__(
        ...
        modules = [
            ...
            nn.ReLU(inplace=False),
            nn.Conv2d(
                bottleneck_channel, 512, kernel_size=2, stride=1, padding=1, bias=False
            ),
            nn.BatchNorm2d(512),
            nn.ReLU(inplace=False),
...
@register_model_func
def custom_densenet169(
    bottleneck_channel=12,
    bottleneck_idx=7,
    compressor=None,
    decompressor=None,
    short_feature_names=None,
    **kwargs
):
    ...
    bottleneck = Bottleneck4DenseNet(
